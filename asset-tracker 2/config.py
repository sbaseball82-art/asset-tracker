...
FUND_HOLDINGS = {
    # 協会コード:        (表示名,                       保有口数,   ISINコード)
    "29313233":          ("ニッセイNASDAQ100",          36374,    None),  JP90C000PDY6 ← ISINを入れてください
    "89311199":          ("SBI・V・S&P500",             850904,   None),JP90C000J569
    "04311181":          ("iFreeNEXT FANG+",            266105,   None),JP90C000FZD4
    "8931224C":          ("SBI S 米国高配当(年4回)",    1955365,  None),JP90C000REE2 
}
